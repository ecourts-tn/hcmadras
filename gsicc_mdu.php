...
<div class="pad group">
<h2 class="post-title" align="center">Gender Sensitization - II (Madurai Bench)</h2>
	...
	<div class="post-inner post-hover">
		...
		<div class="post-thumbnail">
									...
									<!--<img width="520" height="245" src="images/gsicc2.jpg" />-->																			
  ...
  <tbody>
    <?php
	 ...
	 $qry = $DB_con->query("select * from mhc_document where display='Y' and doc_show_page='G' AND doc_bench='MDU' order by doc_order ASC");
while($row = $qry->fetch())
{
