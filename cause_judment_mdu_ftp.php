...
<div class="center1 ">
	...
	<div class="pad group">
					<div class="post-title"  align="center">
						<div class="card deco-none red-class" align="center"><i class=""></i>&nbsp;&nbsp;MADURAI BENCH JUDGMENT</div>
						</div>
...
<?php	
										...
										<p class="form-submit" style="margin: 20px auto; text-align:center;">
										  <input name="submit" type="submit" id="pdf_submit" class="submit" value="SUBMIT">
										</p>
			...
			<div class="main">
				<div class="main-inner group">
				   <div class="content">
					<div class="pad group">
					<div class="post-title"  align="center">
						<div class="card" align="center"><i class=""></i>&nbsp;&nbsp;MADURAI BENCH JUDGMENT</div>
						</div>
								...
								<div id="comments" class="themeform">	
									...
									<form action="#" method="post" id="casenosearch" class="commentform comment-form">					
										...
										<p class="comment-form-author">
										   ...
										   <input type="text" class="form-control" id="RegCase_no" name="RegCase_no" placeholder="Case No" autocomplete="off"  onkeypress="return isNumber(event)">
										</p>
										
										<p class="comment-form-author">
										   <label for="RegCase_year">Year <span class="required">*</span></label> 
										   <input type="text" class="form-control" maxlength="4" id="RegCase_year" name="RegCase_year" placeholder="Year"  autocomplete="off"  onkeypress="return isNumber(event)">
										</p>						
										<div style="clear:both;"></div>				
                                        <?php	
										    $options = array(
								...
								<div id="comments" class="themeform">	
									...
									<form action="#" method="post" id="partysearch" class="commentform comment-form">					
										<p class="comment-form-author">
										  ...
										  <input type="text" name="party_name" id="party_name" class="form-control" placeholder="Enter Pet./Res.Name" autocomplete="off" required onkeypress="return onlyAlphabets(event)">
								...
								<div id="comments" class="themeform">	
									...
									<form action="#" method="post" id="judgesearch" class="commentform comment-form">					
										<p class="comment-form-author">
										  ...
										  <input type="text" name="judge_name" id="judge_name" class="form-control" placeholder="Judge Name" autocomplete="off" required onkeypress="return onlyAlphabets(event)">
										</p>																	
		...
		posting.done(function( data ) {						
			...
			*/
			...
			document.getElementById('pdf_captcha_img').src = '/securimage_show.php?namespace=pdfform&' + Math.random();
				...
				document.getElementById('myTest').submit();
			}
			if(data=='0'){
...
$("#casenosearch").validate({
	...
	submitHandler: function(form) {
		...
		var posting = $.post( "cause_judment_action_mdu_ftp.php", { RegCase_type:$("#RegCase_type").val(),RegCase_no:$("#RegCase_no").val(),RegCase_year:$("#RegCase_year").val(),caseno_captcha:$("#caseno_captcha").val()});
		posting.done(function( data ) {						
		    //$("#orddate_captcha").val("");
			$("#caseno_search_result").html(data);
...
$("#partysearch").validate({
	...
	submitHandler: function(form) {
		...
		var posting = $.post( "cause_judment_action_mdu_ftp.php", { party_name:$("#party_name").val(),from_date:$("#from_date").val(),to_date:$("#to_date").val(),party_captcha:$("#party_captcha").val(),party_type:party_type});
		posting.done(function( data ) {						
		    //$("#orddate_captcha").val("");
...
$("#judgesearch").validate({
	...
	messages: {		
		judge_name: {
			required: "Please enter atleast 4 characters in Judge Name"
	...
	submitHandler: function(form) {
		...
		var posting = $.post( "cause_judment_action_mdu_ftp.php", { judge_name:$("#judge_name").val(),jud_from_date:$("#jud_from_date").val(),jud_to_date:$("#jud_to_date").val(),judge_captcha:$("#judge_captcha").val()});
		posting.done(function( data ) {						
		    //$("#orddate_captcha").val("");
...
$("#order_datesearch").validate({
	...
	submitHandler: function(form) {
		...
		var posting = $.post( "cause_judment_action_mdu_ftp.php", { order_date:$("#order_date").val(),orddate_captcha:$("#orddate_captcha").val()});
		posting.done(function( data ) {						
		    //$("#orddate_captcha").val("");
