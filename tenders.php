...
<div class="pad group">
		...
		<h2 class="post-title" align="center">Tenders </h2><br>
	<div >
...
<table id="example" class="display responsive" cellspacing="0" width="100%">
  ...
  $i=1;
  $curr_dt=date('Y-m-d');
	 $qry = $DB_con->query("select * from mhc_document where display='Y' and doc_show_page='T' order by doc_order DESC,doc_f_date DESC");
while($row = $qry->fetch())
{
