...
<?php	
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if( isset($_POST['cino']) && !empty($_POST['cino']) ){
			
			$cino=base64_decode($_POST['cino']);
			 
						$cnr_no =   check_input($cino);
...
<?php						
					...
					echo '<h3 style="color:red;" align="center">No Records</h3>';
				}//emtpy input
