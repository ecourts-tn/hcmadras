...
{ 	
    ...
    if($_POST['submit'] && $_POST['cause_list_dt']!='' && $_POST['court_no']!='' && is_numeric($_POST['court_no']))
{
...
$causelist_dt=$_POST['cause_list_dt'];
 ...
 $bench_id='';
 $cause_list_title=$MDU_HCMAS_DB->query("SELECT causelist_sr_no,for_bench_id,causelist_id,causelist_date,court_id FROM causelist_title WHERE cause_list_status='P' AND court_id='".$court_no."' AND causelist_date ='".$causelist_date."' order by causelist_id ");
