...
.prof_pic p p{text-align:justify;}
...
<h2 class="post-title" align="center">Hon'ble Judges</h2><br>
 ...
 <table id="table_id2"  >
    ...
    <tbody>
		...
		$cur=date('Y-m-d');
		$sno=1;
	$sql1 = $DB_con->query("select * from judges where j_display='Y'  and  j_page='PJ' and j_ret>='".$cur."' order by j_sen asc");
