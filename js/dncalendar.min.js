...
var notesGroup="";if(settings.showNotes){var notes=getNotesThisMonth();var notesLength=notes.length;if(notesLength>0){notesGroup=$("<ul class='dncalendar-note-list'></ul>");for(var i=0;i<notesLength;i++){var date=notes[i].date;var noteList=notes[i].notes;var noteListLength=noteList.length;var list="";
//echo holiday list
/*list+="<li class='date'>";list+="<span>"+date+"</span>";if(noteListLength>0){list+=" : ";for(var j=0;j<noteListLength;j++){list+=noteList[j];if(noteListLength<=j){list+=", "}}}
