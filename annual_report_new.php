...
<div class="pad group">
		...
		<h2 class="post-title" align="center">Annual Report</h2><br>
...
<table id="example" class="display responsive nowrap" cellspacing="0" width="100%">
  ...
  $i=1;
  $curr_dt=date('Y-m-d');
 $qry = $DB_con->query("select * from mhc_document where display='Y' and doc_show_page='A'  order by doc_order DESC");
while($row = $qry->fetch())
{
    ...
    <tr>
      ...
      <td><form method="GET" action="admin/view_pdf.php" target="_blank"  style="margin-top: -100px;  ">
