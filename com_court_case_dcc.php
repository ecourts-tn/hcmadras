...
<div class="pad group">
		...
		<h2 class="post-title" align="center">Dedicated Commercial Court Cases</h2><br>
	<div >
...
<table id="example" class="display responsive" cellspacing="0" width="100%">
  ...
  $new='';
 $qry = $DB_con->query("select * from mhc_document where display='Y' and doc_show_page='C' and doc_bench in ('DCC') order by doc_order desc, doc_f_date desc");
while($row = $qry->fetch())
{
