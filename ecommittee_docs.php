...
<div class="pad group">
		...
		<h2 class="post-title" align="center">e-Committee Notifications / Documents </h2><br>
	<div >
...
<table id="example" class="display responsive" cellspacing="0" width="100%">
  ...
  <thead>
    <tr align="center">
      ...
      <th style="width:75%" align="left">Notifications / Documents</th>   
  ...
  $i=1;
  $curr_dt=date('Y-m-d');
	 $qry = $DB_con->query("select * from mhc_document where display='Y' and doc_show_page='M' order by doc_order DESC");
while($row = $qry->fetch())
{
