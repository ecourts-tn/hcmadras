...
$("#casenosearch").validate({
	...
	submitHandler: function(form) {
		...
		var posting = $.post( "cause_judment_action_ftp.php", { RegCase_type:$("#RegCase_type").val(),RegCase_no:$("#RegCase_no").val(),RegCase_year:$("#RegCase_year").val(),caseno_captcha:$("#caseno_captcha").val()});
		posting.done(function( data ) {						
		    //$("#orddate_captcha").val("");
			$("#caseno_search_result").html(data);
...
$("#partysearch").validate({
	...
	submitHandler: function(form) {
		...
		var posting = $.post( "cause_judment_action_ftp.php", { party_name:$("#party_name").val(),from_date:$("#from_date").val(),to_date:$("#to_date").val(),party_captcha:$("#party_captcha").val(),party_type:party_type});
		posting.done(function( data ) {						
		    //$("#orddate_captcha").val("");
...
$("#judgesearch").validate({
	...
	submitHandler: function(form) {
		...
		var posting = $.post( "cause_judment_action_ftp.php", { judge_name:$("#judge_name").val(),jud_from_date:$("#jud_from_date").val(),jud_to_date:$("#jud_to_date").val(),judge_captcha:$("#judge_captcha").val()});
		posting.done(function( data ) {						
		    //$("#orddate_captcha").val("");
...
$("#order_datesearch").validate({
	...
	submitHandler: function(form) {
		...
		var posting = $.post( "cause_judment_action_ftp.php", { order_date:$("#order_date").val(),orddate_captcha:$("#orddate_captcha").val()});
		posting.done(function( data ) {						
		    //$("#orddate_captcha").val("");
