...
if($_POST['submit'] && $_POST['cause_list_dt']!='' && $_POST['enroll_id']!='' && $_POST['bench']!='')
{
...
//echo 'SELECT cino FROM civil_t WHERE pet_adv_cd =".$adv_code." OR res_adv_cd =".$adv_code';
 $civ_qry=$DB_option->query("SELECT cino FROM civil_t WHERE pet_adv_cd =".$adv_code." OR res_adv_cd =".$adv_code." union
...
//ECHO "SELECT for_bench_id FROM cause_list WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."' and elimination='N' UNION SELECT for_bench_id FROM cause_list_a WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."' and elimination='N'";
 $jud_bench_qry=$DB_option->query("SELECT for_bench_id FROM cause_list WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."' and elimination='N' UNION SELECT for_bench_id FROM cause_list_a WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."' and elimination='N'");
