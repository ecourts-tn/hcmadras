...
<div class="pad group">
		...
		<h2 class="post-title" align="center"> Bribe giving and receiving is an offence</h2><br>
 ...
 <div id="my_pdf_viewer">
        ...
        <div id="navigation_controls">
            ...
            <input id="current_page" value="1" type="number" min='1' onkeypress="return validateData(event)"/>
 ...
 $qry = $DB_con->query("select * from mhc_document where display='Y' and doc_show_page='B'  order by doc_order ASC");
if($row = $qry->fetch())
{
	
	$id=base64_encode($row['doc_id']);
