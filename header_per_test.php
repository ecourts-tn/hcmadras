...
//echo 'url-'.$currentURL.'<br>rurl-'.$referrer_url.'<br>ip-'.$user_ip_address.'<br>user-'.$user_agent;
...
<script type="text/javascript" language="javascript" src="js/dataTables.responsive1.js"></script>
...
<a class="small" style="color:#333; text-decoration: none;" href="#" onclick="font_default()" title="font none icon">A<sup></sup></a> 
						...
						<div class="container-inner">	
							...
							<div class="search-expand">
								<div class="search-expand-inner">
									<form method="post" class="searchform themeform" id="frm" action="search.php">
	    <div>	
		...
		<div class="container-inner group">
							...
							<div class="group pad">
					<h1 class="site-title"><a href="index.php" rel="home" title="Home Pages"><img src="wp-content/uploads/sites/6/2019/03/logo-mhc.png"  title="Madras High Court" alt="MHC"></a></h1>
...
<script type='text/javascript' src='js/pageload1.js'></script>
