...
<div class="pad group">
		...
		<h2 class="post-title" align="center">Reference Judgments</h2><br>
	<div >
...
<table id="example" class="display responsive" cellspacing="0" width="100%">
  ...
  <thead>
    <tr align="center">
      ...
      <th style="width:60%" >Case number & order date</th>     
  ...
  $i=1;
 $curr_dt=date('Y-m-d');
 $qry = $DB_con->query("select * from mhc_document where display='Y' and doc_show_page='R' order by doc_order desc, doc_f_date desc");
while($row = $qry->fetch())
{
