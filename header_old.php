...
<li id="menu-item-4048" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-4048"><a href="screenreaderac.php">Screen readers access</a>

</li>

<li id="menu-item-3999" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3999">
<a class="small" style="color:#333; text-decoration: none;" href="#" onclick="font_incr()">A<sup>+</sup></a>
</li>

<li id="menu-item-3999" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3999">
<a class="small" style="color:#333; text-decoration: none;" href="#" onclick="font_decr()">A<sup>-</sup></a> 
</li>

<li id="menu-item-3999" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-3999">
<a class="small" style="color:#333; text-decoration: none;" href="#" onclick="font_default()">A<sup></sup></a> 
</li>
						...
						<div class="container-inner">	
						    ...
						    <div class="toggle-search">
							  <div id="colorpicker" >
								<a id="default" rel="default" href="#"  class="styleswitch"><img src="images/theme_default.jpg" alt="Default Theme"  alt="Default Theme"></a>&nbsp;&nbsp;&nbsp;
								<a id="blue" href="#" rel="styles3"  class="styleswitch"><img src="images/theme_blue.jpg" alt="Blue Theme"  alt="Blue Theme"></a>&nbsp;&nbsp;&nbsp;
								<a id="orange" href="#" rel="styles1" class="styleswitch"><img src="images/theme_orange.jpg" alt="Orange Theme"  alt="Orange Theme"></a>&nbsp;&nbsp;&nbsp;
								<a id="green" rel="styles4" href="#"  class="styleswitch"><img src="images/theme_green.jpg" alt="Green Theme"  alt="Green Theme"></a>&nbsp;&nbsp;&nbsp;
								<!--<a id="darkblue" rel="styles2" href="#"  class="styleswitch"><img src="assets/images/theme_darkblue.jpg" alt="" title=""></a>&nbsp;&nbsp;&nbsp;-->
								<a id="yellow" rel="styles2" href="#"  class="styleswitch"><img src="images/theme_yellow.jpg" alt="Yellow Theme" alt="Yellow Theme"></a>
								&nbsp;&nbsp;&nbsp;
								<a id="black" rel="styles5" href="#"  class="styleswitch"><img src="images/theme_black.jpg" alt="Blind Blck Theme"  alt="Blind Blck Theme"></a>
							</div>
							</div>
						
							<!--<div class="toggle-search"><font size="2px">Search&nbsp;&nbsp;</font><i class="fa fa-search"></i></div
							<div class="search-expand">
								<div class="search-expand-inner">
									<form method="get" class="searchform themeform" action="http://localhost/test_design/hc/">
										<div>
		...
		<div class="container-inner group">
							...
							<div class="group pad">
					<h1 class="site-title"><a href="index.php" title="home"><img src="wp-content/uploads/sites/6/2019/03/logo-mhc.png"  alt="Madras High Court" ></a></h1>
											<p class="site-description"></p>
																<ul class="social-links">
																<!--<li><a rel="nofollow" class="social-tooltip" title="Log In" href="admin/index.php" >Log In<i class="fa fa-sign-in" ></i></a></li>-->																
																<!--<li><a rel="nofollow" class="social-tooltip" title="Home" href="index1.php" ><i class="fa fa-home" ></i></a></li>-->																
