...
if($_POST['submit'] && $_POST['cause_list_dt']!='' && $_POST['adv_name']!='' && $_POST['bench']!='')
{
...
$civ_qry=$DB_option->query("SELECT cino FROM civil_t WHERE pet_adv ILIKE  '%".$adv_name."%' OR res_adv ILIKE '%".$adv_name."%' UNION SELECT cino FROM civil_t_a WHERE pet_adv ILIKE  '%".$adv_name."%' OR res_adv ILIKE '%".$adv_name."%' union SELECT cino FROM extra_adv_t WHERE adv_name ILIKE '%".$adv_name."%'");
...
$jud_bench_qry=$DB_option->query("SELECT for_bench_id FROM cause_list WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."'  and elimination='N' group by for_bench_id UNION SELECT for_bench_id FROM cause_list_a WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."'  and elimination='N' group by for_bench_id");
