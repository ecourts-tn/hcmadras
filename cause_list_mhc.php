...
$(function(){
	...
	$("#cause_list_jud").validate({
		...
		submitHandler: function(form) {
			...
			var posting = $.post( "cause_list_jud.php", { cause_list_dt:$("#cause_list_dt2").val(), jud_cd :$("#jud_cd").val(),judgename_captcha:$("#judgename_captcha").val(),submit:$("#submit").val()});
			posting.done(function( data ) {
		...
		submitHandler: function(form) {
			...
			var posting = $.post( "cause_list_advcd.php", { cause_list_dt:$("#cause_list_dt3").val(), enroll_id :$("#enroll_id").val(),aorno_captcha:$("#aorno_captcha").val(),submit:$("#submit").val()});
			posting.done(function( data ) {
	...
	$("#cause_list_adv_name").validate({
		...
		submitHandler: function(form) {
			...
			var posting = $.post( "cause_list_adv_name.php", { cause_list_dt:$("#cause_list_dt4").val(), adv_name :$("#adv_name").val(),advname_captcha:$("#advname_captcha").val(),submit:$("#submit").val()});
			posting.done(function( data ) {
	...
	$("#cause_list_case").validate({
		...
		submitHandler: function(form) {
			...
			var posting = $.post( "cause_list_case.php", { cause_list_dt:$("#cause_list_dt5").val(), case_type :$("#case_type").val(),case_no :$("#case_no").val(),case_year :$("#case_year").val(),caseno_captcha:$("#caseno_captcha").val(),submit:$("#submit").val()});
			posting.done(function( data ) {
	...
	$("#partyname_list_case").validate({
		...
		submitHandler: function(form) {
			...
			var posting = $.post( "cause_list_party_name.php", { cause_list_dt:$("#cause_list_dt6").val(), party_name :$("#party_name").val(),partyname_captcha:$("#partyname_captcha").val(),submit:$("#submit").val()});
			posting.done(function( data ) {
	...
	$("#entire_list_case").validate({
		...
		submitHandler: function(form) {
			...
			//window.open("cause_list_entire.php");			
			var posting = $.post( "cause_list_entire.php", { cause_list_dt:$("#cause_list_dt7").val(), entirecause_captcha:$("#entirecause_captcha").val(),submit:$("#submit").val()});
			posting.done(function( data ) {
	...
	function getCauseListValue()
	{
		if($("#cause_list_dt2").val()){
			$("#jud_cd").html('');
		var jud_list=$.post("get_jud_list.php",{getCauseListValue:true,bench:'MHC',cause_date:$("#cause_list_dt2").val()});
