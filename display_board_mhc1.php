...
<section id="team" class="pb-5">
    <div class="container">
        <h5 class="section-title h1"><?php echo date("d/m/Y");?> Principal Seat of Madras High Court Display board <span  id='ct6'></span> <input class="btn btn-default" style="
    background-color: #d00707;
    font-size: 20px;
    color: white;
    font-weight: bold;cursor: pointer;" type="button" value="Refresh" onclick="mhc_refresh()"></h5>
