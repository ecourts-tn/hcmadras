...
.card3 {
  ...
  background:#42B7E3
	...
	#party_name_captcha_img{padding:5px 0px 0px 20px}
   ...
   <div id="wrapper">
	<div class="pad group">
					<div class="post-title"  align="center">
						<div class="card3" align="center"><i class=""></i>&nbsp;&nbsp;MADRAS HIGH COURT - CASE STATUS</div>
						</div>
...
<script>
	...
	$("#caseno_searchform").validate({
		...
		submitHandler: function(form) {			
			...
			var posting = $.post( "case_status_result.php", { case_nme:$("#RegCase_type").val(), case_no :$("#RegCase_no").val(), case_year:$("#RegCase_year").val(),caseno_captcha:$("#caseno_captcha").val()});
	...
	$("#party_searchform").validate({
		...
		submitHandler: function(form) {			
			...
			var posting = $.post( "party_status_result_list.php", {party_name:$("#party_name").val(),from_date:$("#from_date").val(),to_date:$("#to_date").val(),party_name_captcha:$("#party_name_captcha").val(),party_type:party_type});
			posting.done(function( data ) {
