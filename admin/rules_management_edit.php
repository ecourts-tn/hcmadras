...
{
if($rules_fun->rules_update($edit_id,$rules_title,$doc_pdf,$rules_size,$date_up,$rules_lan,$new,$rules_order,$display,$mhc_user,$page_id,$ip,$log_fun))
{
							unset($error);
							$rules_fun->redirect("rules_management.php?joined1&CheckString=".$chkstr."&".md5('page_id')."=".$page_id); 
						}
}						
}
else
{
	//$error=$edit_id.$rules_title.$rules_size.$date_up.$rules_lan.$new.$rules_order.$display.$mhc_user;
	if($rules_fun->rules_update1($edit_id,$rules_title,$date_up,$rules_lan,$new,$rules_order,$display,$mhc_user,$page_id,$ip,$log_fun))
{
							unset($error);
							$rules_fun->redirect("rules_management.php?joined1&CheckString=".$chkstr."&".md5('page_id')."=".$page_id); 
						} 
		 	 ...
		 	 if(isset($_GET['edit_id']))
{
 ...
 $stmt = $DB_con->prepare("SELECT  * FROM mhc_rules where rules_id=:id");
 ...
 ?>
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">Rules Edit Form</div>
								<?php
				if(isset($error))
            {
			...
			?>
								...
								<input type="hidden" name="edit_id" value="<?php  if(isset($_GET['edit_id'])){ print($editRow['rules_id']); }?>" >
                                    <div class="form-row">
                                        <div class="col-md-4 form-group mb-3">
                                            <label for="validationTooltip01">Rules Title</label>
                                            <input class="form-control" id="rules_title" name="rules_title" type="text" placeholder="Rules name"  required="required" aria-describedby="validationTooltipFirstPrepend" onKeyPress="return ValidateAlpha(event);" autocomplete="off" value="<?php  if(isset($_GET['edit_id'])){ print($editRow['rules_title']); }?>"/>
										...
										<div class="col-md-4 form-group mb-3">
                                         ...
                                         <div class="input-group">
                                                ...
                                                <input class="form-control datepicker" id="rules_date" name="rules_date" type="text" placeholder="Downloads on" aria-describedby="validationTooltipPasswordPrepend"  autocomplete="off" value="<?php  if(isset($_GET['edit_id'])){ print($upload_date); }?>"/>
                                                <div class="invalid-tooltip">
                                            ...
                                            <label for="validationTooltipUsername">Rules Language</label>
                                             <select class="form-control" id="rules_lan" name="rules_lan" type="text" placeholder="Rules Language"  autocomplete="off" />
											  <option value="">Choose</option>
                                               <option value="English"<?php  if(isset($_GET['edit_id'])){ if($editRow['rules_lan']=='English'){ echo "SELECTED"; }}?>>English</option>
											   <option value="Tamil"<?php  if(isset($_GET['edit_id'])){ if($editRow['rules_lan']=='Tamil'){ echo "SELECTED"; }}?>>Tamil</option>
                                            </select>
                                            <div class="invalid-tooltip">
										...
										<div class="col-md-2 form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control Number" id="rules_order" name="rules_order" type="text" placeholder="Downloads Order" aria-describedby="validationTooltipPasswordPrepend"  autocomplete="off" value="<?php  if(isset($_GET['edit_id'])){ print($editRow['rules_order']); }?>" />
                                                <div class="invalid-tooltip">
										...
										<div class="col-md-3 form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <option value="">Choose</option>
                                             <option value="Y"<?php  if(isset($_GET['edit_id'])){ if($editRow['rules_new_icon']=='Y'){ echo "SELECTED"; }}?>>Yes</option>
											   <option value="N"<?php  if(isset($_GET['edit_id'])){ if($editRow['rules_new_icon']=='N'){ echo "SELECTED"; }}?>>No</option>
                                            </select>
                                            </div>
                                        </div>
										<div class="col-md-4 form-group mb-3">
