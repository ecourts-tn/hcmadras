...
if($holiday_fun->holiday_add($holiday_title,$holiday_year,$holiday_from,$holiday_to,$display,$mhc_user,$page_id,$ip,$log_fun))
{
			unset($error);
			  $holiday_fun->redirect("holiday_management.php?joined&CheckString=".$chkstr."&".md5('page_id')."=".$page_id); 
   ...
   $del_id=$_GET['remove'];
	$page_id=$_GET['page_id'];	
		...
		if($holiday_fun->holiday_Delete($del_id,$mhc_user,$page_id,$ip,$log_fun)) 
            {
	    
          $holiday_fun->redirect("holiday_management.php?joined2&CheckString=".$chkstr."&".md5('page_id')."=".$page_id);
...
$Get_holiday_details= $holiday_fun->holidaydata($chkstr,$page_id);
}
catch(PDOException $e)
     {
        echo $e->getMessage();
 ...
 ?>
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            {
                 ?>
				 <div class="alert alert-card alert-success" role="alert"><strong class="text-capitalize">Holiday Added Successfully </strong>
                            <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        </div>
                                ...
                                <form class="needs-validation" novalidate="novalidate" action="" method="POST" enctype="multipart/form-data" onSubmit="return Validator(this)">
                                    <div class="form-row">
                                        <div class="col-md-4 form-group mb-3">
                                            ...
                                            <input class="form-control" id="holiday_title" name="holiday_title" type="text" placeholder="Holiday name"  required="required" aria-describedby="validationTooltipFirstPrepend" onKeyPress="return ValidateAlpha(event);" autocomplete="off" />
    ...
    print '<option value="'.$i.'"'.($i == $currently_selected ? ' selected="selected"' : '').'>'.$i.'</option>';
                                       ...
                                       <div class="col-md-2 form-group mb-3">
                                         ...
                                         <div class="input-group">
                                                ...
                                                <input class="form-control datepicker" id="holiday_f_date" name="holiday_f_date" type="text" placeholder="Downloads on" aria-describedby="validationTooltipPasswordPrepend"  autocomplete="off" />
                                                <div class="invalid-tooltip">
										...
										<div class="col-md-2 form-group mb-3">
                                         ...
                                         <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text" id="validationTooltipPasswordPrepend">@</span></div>
                                                <input class="form-control datepicker" id="holiday_t_date" name="holiday_t_date" type="text" placeholder="Downloads on" aria-describedby="validationTooltipPasswordPrepend"  autocomplete="off" />
                                                <div class="invalid-tooltip">
					 ...
					 <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                <h4 class="card-title mb-3">Holiday Management</h4>
                                <p></p>
