...
try
		{
				...
				echo"haii". $slider_name=htmlspecialchars(filter_input(INPUT_POST, 'slider_title', FILTER_SANITIZE_STRING));
...
{
if($slid_fun->slider_update($edit_id,$bench,$slider_name,$slid_img,$up_date,$slider_ord,$display,$mhc_user,$slider_url,$page_id,$ip,$log_fun))
{
...
{
	if($slid_fun->slider_update1($edit_id,$bench,$slider_name,$up_date,$slider_ord,$display,$mhc_user,$slider_url,$page_id,$ip,$log_fun))
{
	//$error=' successfull!</h3>';
							unset($error);
							$slid_fun->redirect("slider_management.php?joined&CheckString=".$chkstr."&".md5('page_id')."=".$page_id); 
		 ...
		 if(isset($_GET['edit_id']))
{
 ...
 $stmt = $DB_con->prepare("SELECT  * FROM mhc_sliders where slider_id=:id");
 $stmt->execute(array(':id' => $edit));
 $editRow=$stmt->FETCH(PDO::FETCH_ASSOC);
 
  if(is_null($editRow['slider_up_date']))
 {
	 $slider_up_date='';
 }
 else
 {
	 $slider_up_date=date('d-m-Y',strtotime($editRow['slider_up_date']));
 }
} 
 ?>
        <div class="main-content-wrap sidenav-open d-flex flex-column">
			...
			?>
                                <form class="needs-validation" novalidate="novalidate" action="" method="POST" enctype="multipart/form-data" onSubmit="return Validator(this)">
								 <input type="hidden" name="edit_id" value="<?php  if(isset($_GET['edit_id'])){ print($editRow['slider_id']); }?>" >
                                    <div class="form-row">
								...
								if($d_qry->rowCount() > 0){
										...
										<div class="col-md-4 form-group mb-3">
                                            ...
                                            <input class="form-control" id="slider_title" name="slider_title" type="text" placeholder="Slider name"  required="required" aria-describedby="validationTooltipFirstPrepend" onKeyPress="return ValidateAlpha(event);" autocomplete="off" value="<?php  if(isset($_GET['edit_id'])){ print($editRow['slider_name']); }?>"/>
                                            <div class="invalid-tooltip">
										...
										<div class="col-md-4 form-group mb-3">
											...
											<img src="view_image.php?img_id=<?php echo  base64_encode($editRow['slider_id'])?>&page=<?php echo  base64_encode('S')?>" width="50" height="50" />
											 <div class="custom-file">
                                        <input class="custom-file-label" id="slider_img" name="slider_img" type="file" aria-describedby="inputGroupFileAddon01"  onchange="return ValidateFileUpload()">
										...
										<div class="col-md-1 form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control Number" id="slider_ord" name="slider_ord" type="text" placeholder="Slider Order" aria-describedby="validationTooltipPasswordPrepend"  autocomplete="off" required="required" value="<?php  if(isset($_GET['edit_id'])){ print($editRow['slider_order']); }?>"/>
                                                <div class="invalid-tooltip">
										...
										<div class="col-md-3 form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="slider_url" name="slider_url" type="text" placeholder="Slider URL" aria-describedby="validationTooltipPasswordPrepend"  autocomplete="off" required="required" value="<?php  if(isset($_GET['edit_id'])){ print($editRow['slider_url']); }?>"/>
                                                <div class="invalid-tooltip">
                                        ...
                                        <div class="col-md-4 form-group mb-3">
                                         ...
                                         <div class="input-group">
                                                ...
                                                <input class="form-control datepicker" id="up_date" name="up_date" type="text" placeholder="Uploads on" aria-describedby="validationTooltipPasswordPrepend"  autocomplete="off" required="required" value="<?php  if(isset($_GET['edit_id'])){ print($slider_up_date); }?>"/>
                                                <div class="invalid-tooltip">
										...
										<div class="col-md-4 form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <option value="">Choose</option>
                                              <option value="Y"<?php  if(isset($_GET['edit_id'])){ if($editRow['slider_display']=='Y'){ echo "SELECTED"; }}?>>Yes</option>
											   <option value="N"<?php  if(isset($_GET['edit_id'])){ if($editRow['slider_display']=='N'){ echo "SELECTED"; }}?>>No</option>
                                            </select>
                                            </div>
                                        </div>
