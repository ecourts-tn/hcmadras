					 ...
					 <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p style="float:right"> <a class="btn btn-primary text-white " href="f_jud_management.php?CheckString=<?php echo $chkstr; ?>&<?php echo md5('page_id')?>=<?php echo $page_id ?>" >Back</a></p>
...
//alert(page_id_array);
   $.ajax({
    url:"action.php",
    method:"POST",
    data:{page_id_array:page_id_array, action:'f_jud_update'},
    success:function()
    {
