...
$Get_reg_details= $reg_fun->regdata($chkstr,$page_id);
}
catch(PDOException $e)
     {
        echo $e->getMessage();
 ...
 ?>
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">New Registrar Registration Form</div>
								<?php
				if(isset($error))
            {
            ...
            {
                 ?>
				 <div class="alert alert-card alert-success" role="alert"><strong class="text-capitalize">New Registrar Added Successfully </strong>
                            <button class="close" type="button" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        </div>
...
?>
                        ...
                        <input type="text" name="cont_no[]" class="form-control Number" placeholder="Enter Contact Number" maxlength="12"    autocomplete="off">
                        ...
                        <input type="text" name="fax_no[]" class="form-control Number" placeholder="Fax No" aria-describedby="validationTooltipemailidPrepend"  autocomplete="off" maxlength="12">
                        <span class="input-group-btn">
                            <button type="button" class="btn btn-success btn-add">+</button>
                        </span>
                    </div>
								...
								if($d_qry->rowCount() > 0){
									...
									<div class="form-row">
                                        <div class="col-md-4 form-group mb-3">
                                            ...
                                            <input class="form-control Number" id="reg_pri" name="reg_pri" type="text" placeholder="Registrar Priority" required="required"  autocomplete="off" maxlength='2' />
                                            <div class="invalid-tooltip">
					 ...
					 <div class="col-md-12 mb-4">
                        <div class="card text-left">
                            <div class="card-body">
                                ...
                                <p style="float:right"> <a class="btn btn-primary text-white " href="reg_management_order.php?CheckString=<?php echo $chkstr; ?>&<?php echo md5('page_id'); ?>=<?php echo $page_id ?>">Ordering</a></p>
