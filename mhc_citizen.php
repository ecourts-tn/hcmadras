...
<div class="pad group">
		...
		<h2 class="post-title" align="center">Citizen's Charter</h2><br>
 ...
 <div id="my_pdf_viewer">
  ...
  <?php
  $i=1;
 $qry = $DB_con->query("select * from mhc_document where display='Y' and doc_show_page='N'  order by doc_order ASC");
if($row = $qry->fetch())
{
