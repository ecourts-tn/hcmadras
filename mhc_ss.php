...
<div class="pad group">
		...
		<h2 class="post-title" align="center">Security System</h2><br>
 ...
 $qry = $DB_con->query("select * from mhc_document where display='Y' and doc_show_page='Z'  order by doc_order ASC");
if($row = $qry->fetch())
{
