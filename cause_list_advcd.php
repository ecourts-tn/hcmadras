...
//echo 'SELECT cino FROM civil_t WHERE pet_adv_cd =".$adv_code." OR res_adv_cd =".$adv_code';
 $civ_qry=$HCMAS_DB->query("SELECT cino FROM civil_t WHERE pet_adv_cd =".$adv_code." OR res_adv_cd =".$adv_code." union
SELECT cino FROM extra_adv_t WHERE adv_code =".$adv_code );
 ...
 $cnr_num=rtrim($cnr_no,',');
	 ...
	 $cnr_num ="''";
 $bench_id ='';
//ECHO "SELECT for_bench_id FROM cause_list WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."' and elimination='N' UNION SELECT for_bench_id FROM cause_list_a WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."' and elimination='N'";
 $jud_bench_qry=$HCMAS_DB->query("SELECT for_bench_id FROM cause_list WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."' and elimination='N' UNION SELECT for_bench_id FROM cause_list_a WHERE cino IN (".$cnr_num.") and causelist_date='".$causelist_date."' and elimination='N'");
