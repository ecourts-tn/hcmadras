...
if($_POST['submit'] && $_POST['cause_list_dt']!='' && $_POST['case_type']!='' && $_POST['case_no']!='' && $_POST['case_year']!='' && $_POST['bench']!='' )
{
