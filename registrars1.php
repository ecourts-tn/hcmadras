...
<table id="example" width="100%" class="display responsive">
 ...
 $qry_reg = $DB_con->query("SELECT * FROM registrars where trim(reg_place)='MHC' and display='Y' order by reg_pl_sen asc");
$i=1;
while ($row_reg = $qry_reg->fetch())
	...
	$select_qry = $DB_con->query("select sno,desig from officer_designation where display='Y' and sno='".$row_reg['reg_desig']."' order by sno asc");
    ...
    <td style="width:5%"><?php echo $i; ?></td>
      ...
      <td style="width:30%"  align="left"><?php echo $get_row['desig']; ?></td>
